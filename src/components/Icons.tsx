...
const LogoIcon = () => (
  <div style={{
    ...
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--color-white)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/** Wave / activity icon - Fixed to properly accept and use stroke/props */
...
export const Icons = {
  ...
  // Swapped to Regular FontAwesome icons where available
  ...
  // Solid icons (No free Regular alternative)

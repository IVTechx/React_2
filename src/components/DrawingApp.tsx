  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.subtitle}>
        Click anywhere on the canvas below to add points. Use the undo/redo buttons to navigate
        through your drawing history.
      </p>
      ...
      <Canvas canvasRef={canvasRef} points={points} onClick={handleClick} />
